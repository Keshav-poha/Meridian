"""Run Stage 8: simulate masked GNSS outage with adaptive GNSS+INS fusion."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("ml/reports/stage8"))
    ...
    report = {"stage": 8, "blackout_start_s": args.start_seconds, "blackout_duration_s": args.duration_seconds, "residual": residual.as_dict(), **metrics.as_dict()}
